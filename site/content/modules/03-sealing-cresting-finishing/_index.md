---
title: "Sealing, Cresting, and Finishing: Making the Set Last and Look Like a Set"
short_title: "Sealing and Cresting"
type: module
weight: 3
summary: ""
topics: []
blog_post: ""
driving_question: "How do I protect 24 cedar shafts from moisture and give them a finish that makes them look like a matched set?"
concepts:
  - Sealing and finishing (shellac, polyurethane, gasket lacquer)
  - Cresting and crown decoration
  - Dip tube
  - GPP (grains per pound)
contrast:
  alternative: "Parallel shaft (uniform diameter, no taper steps until after finishing)"
  when_alternative_wins: "Parallel shafts allow re-tapering if the nock end splits — remove a short section and re-taper the fresh end. They are also cheaper to source in bulk, and some builders prefer to custom-cut taper angles themselves for tight control over the seating fit."
prior_ends_with: "The learner has 24 (or close to 24) Port Orford cedar shafts that are straight, spine-matched, GPI-matched, and tapered at both ends. They are ready to apply finish and optional cresting."
next_expects: "The learner has 24 sealed, finished, and optionally crested shafts with consistent finish weight. They are ready to attach feathers, nocks, and points."
date: 2026-05-01T18:39:11-06:00
draft: false
---

You have 24 straight, tapered Port Orford cedar shafts, carefully matched by {{< gloss "Spine" "spine" >}} and {{< gloss "GPI (grains per inch)" "GPI" >}}. Now comes the question that will determine whether those shafts stay matched through a season of shooting: how do you lock in their weight, protect them from the moisture that warps cedar and drifts spine, and mark them so you can find your arrows at a communal target from across the range? The answer involves a {{< gloss "Dip tube" >}}, a chosen {{< gloss "Sealer" >}}, optional {{< gloss "Cresting" >}}, and careful arithmetic about {{< gloss "GPP (grains per pound)" >}}.

## The mechanism: sealing, cresting, and why finish weight matters

```mermaid
flowchart TD
    A[Bare tapered shaft] --> B["Dip tube — first coat"]
    B --> C["Hang to dry<br/>24 hrs min"]
    C --> D["Light sand<br/>320 grit"]
    D --> E["Dip tube — second coat"]
    E --> F["Hang to dry<br/>24 hrs min"]
    F --> G{Optional cresting?}
    G -- Yes --> H["Crest bands<br/>+ clear topcoat"]
    G -- No --> I["Weigh each shaft<br/>recalculate GPP"]
    H --> I
    I --> J["24 finished shafts<br/>ready for fletching"]
```

### {{< gloss "Sealer" "Sealer" >}} choice: {{< gloss "Shellac" "shellac" >}}, {{< gloss "Gasket lacquer" "gasket lacquer" >}}, or polyurethane

Not all finishes behave the same in a {{< gloss "Dip tube" >}} or on cedar. The three options you will see most often in practitioner discussion are shellac, gasket lacquer, and polyurethane.[^at-sealer]
...
3. Fill to depth. Measure the deepest your shaft will hang (tip of the {{< gloss "Point taper" "point taper" >}} to the rim of the tube). Fill the finish to that depth plus 1 inch of clearance.
...
The {{< gloss "Point taper" "point taper" >}} and {{< gloss "Nock taper" "nock taper" >}} ends of each shaft are end grain — they absorb finish 2–3× faster than the cylindrical shaft body. If you dip straight into a full-strength finish without accounting for this, the tapered sections will drink in far more sealer than the rest of the shaft. The consequences are two-fold: the finish on the taper builds up thicker, and that extra thickness can interfere with the seating fit of glue-on nocks and field points.[^taper-ends]

The practical fix is simple: after the first full dip coat dries, **give the tapered ends a quick pass with 320-grit** to level any excess buildup before the second coat. Check the {{< gloss "Nock taper" "nock taper" >}} by test-seating a {{< gloss "Nock insert" "plastic nock" >}} — it should slide snugly onto the taper without wobble and should not seat so tight that it requires force. If the nock is too tight after two coats, a light sand of the taper with 220-grit followed by a wipe is enough to recover the correct seating depth.
...
Finish adds weight. Two coats of gasket lacquer or shellac add approximately 5–15 grains per shaft depending on shaft diameter, finish viscosity, and dip speed.[^finish-weight] For a batch of 24 arrows, the goal is not to minimize finish weight — it is to make finish weight **consistent** across all 24 shafts, so the {{< gloss "GPI (grains per inch)" "GPI" >}} match you established in module 2 survives into the finished arrow.
...
|---|---|
| {{< gloss "Port Orford cedar" "Port Orford cedar shaft" >}} (28 in, sealed) | ~290–340 |
| 100-grain {{< gloss "Glue-on field point" "glue-on field point" >}} | 100 |
...
Apply a clear topcoat over the {{< gloss "Cresting" "crest bands" >}} before the arrows move to fletching. The topcoat protects the crest paint from scratching during fletching clamp contact and from abrasion in the quiver. One coat of your dip finish, brushed on lightly over the crest zone only, is sufficient.

## {{< gloss "Tapered shaft" "Tapered shaft" >}} vs. {{< gloss "Parallel shaft" "parallel shaft" >}}: a contrast

{{< gloss "Parallel shaft" "Parallel shafts" >}} are an alternative to pre-tapered cedar shafts and are worth understanding before you commit all 24 shafts to the dip tube.
...
After the dip sequence is complete, the 24 shafts will have a sealed, moisture-resistant finish that locks in the spine and GPI match you built in module 2. The key result is not beauty (though that follows) — it is **consistency of finish weight across all 24 shafts**, which preserves the {{< gloss "GPP (grains per pound)" "GPP" >}} calculation and keeps the batch flying identically. The cresting is how you claim those arrows at the target and mark the set as yours.
...
Module 4 expects 24 sealed, optionally crested, and finish-weight-confirmed shafts — dry and ready for the {{< gloss "Fletching jig" "fletching jig" >}}, nock inserts, and 100-grain field points.
